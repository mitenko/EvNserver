        ...
        <form name="destEditForm">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <a type="button"
                       ng-click="initDestImageCrop();"
                       data-toggle="modal" data-target="#destThumbnailCropModal"
            ...
            <div id="destThumbnailCropModal" class="modal fade" role="dialog">
